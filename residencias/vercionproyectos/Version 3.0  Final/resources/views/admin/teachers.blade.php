...
@section('jumbotron')
    @include('partials.jumbotron', ['title' => 'Administrar Investigadores', 'icon' => 'unlock-alt'])
@endsection
      ...
      <table class="VueTables__table table table-striped table-bordered table-hover" style="overflow: hidden;">
        <thead>
          <tr>
            ...
            <th id="VueTables_th--id" tabindex="0" class="VueTables__sortable " style="position: relative;">
              <span title="" class="VueTables__heading">Puesto</span>
              <span class="VueTables__sort-icon float-right glyphicon glyphicon-sort "></span>
              <div style="top: 0px; right: 0px; width: 5px; position: absolute; cursor: col-resize; user-select: none; height: 161px;" class="resize-handle"></div>
            </th>
            <th id="VueTables_th--id" tabindex="0" class="VueTables__sortable " style="position: relative;">
          ...
          <tbody>
            ...
            <tr class="VueTables__row " id="{{$teach->id}}">
              <td tabindex="0" class="">{{$teach->grado_academico}} {{$teach->name}}</td>
              <td tabindex="0" class="">{{$teach->email}}</td>
              <td tabindex="0" class="">{{$teach->nom_i}}</td>
              <td tabindex="0" class="">{{$teach->nom_c}}</td>
              <td tabindex="0" class="">{{$teach->puesto}}</td>
              <td tabindex="0" class="">{{$teach->carrera}}</td>
              <td tabindex="0" class="">{{$teach->genero}}</td>
            </tr>
            @endforeach
          </tbody>
        </table>
